...
#Importing variables for ex: from.. import * does not work, loading modules as taught in live session by instructor
...
city_tier_mapping = module_from_file("utils", "/home/dags/Lead_scoring_data_pipeline/mapping/city_tier_mapping.py")
significant_categorical_level = module_from_file("data_validation_checks", "/home/dags/Lead_scoring_data_pipeline/mapping/significant_categorical_level.py")
...
# ##############################################################################
build_dbs = PythonOperator(task_id='building_db', 
