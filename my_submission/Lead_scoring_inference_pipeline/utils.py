'''
filename: utils.py
functions: load_data, __read_input_data, __save_data_to_db, encode_features, get_models_prediction, prediction_ratio_check, input_features_check
...
def prediction_ratio_check(db_path, db_file_name, script_output):
    ...
    result_df.to_csv(outputfile_name, index=None, sep='\t')
